...
#		(Array) An array of objects that have been paginated, the type depends on the subclass used to paginate
	def items_for_current_page
		...
		raise PageNumberOutOfRange.new( "Page Number: #{cp} is out of range: 1..#{count_pages}" ) if !valid_page_number?( cp ) and !count_pages.eql?(0)
		items_on_page( cp )
	end
...
#
#	Returns:
#	(Object): The first item of the current page
	def first_item
		raise NotImplementedError.new "coming soon"
	end

# Last item
#
#	Returns:
#	(Object): The last item of the current page
	def last_item
		raise NotImplementedError.new "coming soon"
	end
...
#
#	Returns:
#	(Object): The first item of the first page
	def first_item_of_all
		items_on_page( 1 ).first
	end
...
#
#	Returns:
#	(Object): The last item of the last page
	def last_item_of_all
		items_on_page( count_pages ).last
	end
