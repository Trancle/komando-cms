class RemoveVideoContentFileBitgravityTask < CW::TaskRunner::Application::TaskRunnerTask

	def run
		begin
			provider = VideoContentHostingProviderOnDemandBitgravity.find( options[:provider_id] )
